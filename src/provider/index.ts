...
// https://registry.terraform.io/providers/hashicorp/dns/3.6.0/docs
...
export class DnsProvider extends cdktn.TerraformProvider {
  ...
  * @param importFromId The id of the existing DnsProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/dns/3.6.0/docs#import import section} in the documentation of this resource for the id to use
