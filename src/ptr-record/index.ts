...
// https://registry.terraform.io/providers/hashicorp/dns/3.6.0/docs/resources/ptr_record
...
export class PtrRecord extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing PtrRecord that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/dns/3.6.0/docs/resources/ptr_record#import import section} in the documentation of this resource for the id to use
