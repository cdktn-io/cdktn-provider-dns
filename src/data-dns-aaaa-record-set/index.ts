...
// https://registry.terraform.io/providers/hashicorp/dns/3.6.1/docs/data-sources/aaaa_record_set
...
export class DataDnsAaaaRecordSet extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDnsAaaaRecordSet that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/dns/3.6.1/docs/data-sources/aaaa_record_set#import import section} in the documentation of this resource for the id to use
