...
// https://registry.terraform.io/providers/hashicorp/dns/3.6.1/docs/resources/a_record_set
...
export interface ARecordSetConfig extends cdktn.TerraformMetaArguments {
  /**
...
*/
export class ARecordSet extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ARecordSet that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/dns/3.6.1/docs/resources/a_record_set#import import section} in the documentation of this resource for the id to use
