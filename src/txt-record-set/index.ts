...
// https://registry.terraform.io/providers/hashicorp/dns/3.6.0/docs/resources/txt_record_set
...
export class TxtRecordSet extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing TxtRecordSet that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/dns/3.6.0/docs/resources/txt_record_set#import import section} in the documentation of this resource for the id to use
