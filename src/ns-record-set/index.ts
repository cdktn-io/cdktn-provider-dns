...
// https://registry.terraform.io/providers/hashicorp/dns/3.6.2/docs/resources/ns_record_set
...
export class NsRecordSet extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing NsRecordSet that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/dns/3.6.2/docs/resources/ns_record_set#import import section} in the documentation of this resource for the id to use
