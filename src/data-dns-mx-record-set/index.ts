...
// https://registry.terraform.io/providers/hashicorp/dns/3.6.1/docs/data-sources/mx_record_set
...
export interface DataDnsMxRecordSetConfig extends cdktn.TerraformMetaArguments {
  /**
  * Domain to look up.
  *
...
export class DataDnsMxRecordSetMxOutputReference extends cdktn.ComplexObject {
...
export class DataDnsMxRecordSetMxList extends cdktn.ComplexList {
...
export class DataDnsMxRecordSet extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDnsMxRecordSet that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/dns/3.6.1/docs/data-sources/mx_record_set#import import section} in the documentation of this resource for the id to use
