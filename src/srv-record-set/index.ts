...
// https://registry.terraform.io/providers/hashicorp/dns/3.6.0/docs/resources/srv_record_set
...
export class SrvRecordSet extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing SrvRecordSet that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/dns/3.6.0/docs/resources/srv_record_set#import import section} in the documentation of this resource for the id to use
