...
// https://registry.terraform.io/providers/hashicorp/dns/3.5.0/docs/data-sources/srv_record_set
...
export interface DataDnsSrvRecordSetConfig extends cdktn.TerraformMetaArguments {
  /**
  * Service to look up.
  *
...
export class DataDnsSrvRecordSetSrvOutputReference extends cdktn.ComplexObject {
...
export class DataDnsSrvRecordSetSrvList extends cdktn.ComplexList {
...
export class DataDnsSrvRecordSet extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDnsSrvRecordSet that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/dns/3.5.0/docs/data-sources/srv_record_set#import import section} in the documentation of this resource for the id to use
