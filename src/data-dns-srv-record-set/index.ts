...
// https://registry.terraform.io/providers/hashicorp/dns/3.6.2/docs/data-sources/srv_record_set
...
export class DataDnsSrvRecordSet extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDnsSrvRecordSet that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/dns/3.6.2/docs/data-sources/srv_record_set#import import section} in the documentation of this resource for the id to use
