...
// https://registry.terraform.io/providers/hashicorp/dns/3.5.0/docs/data-sources/a_record_set
...
export interface DataDnsARecordSetConfig extends cdktn.TerraformMetaArguments {
  /**
  * Host to look up.
  *
...
*/
export class DataDnsARecordSet extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDnsARecordSet that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/dns/3.5.0/docs/data-sources/a_record_set#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DataDnsARecordSet to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "dns_a_record_set", importId: importFromId, provider });
      }
