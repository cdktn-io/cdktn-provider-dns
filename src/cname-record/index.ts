...
// https://registry.terraform.io/providers/hashicorp/dns/3.6.2/docs/resources/cname_record
...
export class CnameRecord extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing CnameRecord that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/dns/3.6.2/docs/resources/cname_record#import import section} in the documentation of this resource for the id to use
