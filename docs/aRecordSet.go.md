...
```go
import "github.com/cdktn-io/cdktn-provider-dns-go/dns/v13/arecordset"
...
| <code><a href="#@cdktn/provider-dns.aRecordSet.ARecordSetConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/dns/3.6.2/docs/resources/a_record_set#id ARecordSet#id}. |
